  ...
  return (
    <div className="policy-page">
      <div className="policy-card">
        ...
        <p><strong>Last Updated:</strong> {t('auto_3170', 'June 2026')}</p>
        <p>{t('auto_3171', 'Welcome to')} <strong>{t('auto_3172', 'royalbookclub.com')}</strong> ("Website"). This Website is owned and operated by an independent, unincorporated group of book enthusiasts based in India ("we," "us," or "our").</p>
