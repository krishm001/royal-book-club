...
const ArticleDetailPage = ({
  ...
  const [comments, setComments] = useState([{
    ...
    content: 'Exquisite analysis of Dorian Gray. The focus on Victorian aestheticism is beautifully argued.',
    date: 'May 28, 2026'
  }, {
    id: 2,
    author: 'Eminent Scholar',
    content: 'I particularly enjoyed the paragraph highlighting Wilde’s private letters. Outstanding scholarship.',
    date: 'May 29, 2026'
  }]);
  ...
  return <div className="article-detail-container animate-fade-in">
      {/* Back to feed */}
      ...
      <article className="royal-card article-detail-view">
        ...
        <div className="article-body-content" dangerouslySetInnerHTML={{
        __html: article.bodyHtml || article.contentHtml
      }} />
      </article>
      ...
      <section className="article-discussion-section royal-card">
        ...
        {/* Comment input form */}
        {user ? <form onSubmit={handleAddComment} className="add-comment-form">
            <input type="text" className="royal-input comment-input" placeholder={t("str_5372", "Contribute your intellectual insight to the thread...")} value={commentText} onChange={e => setCommentText(e.target.value)} required />
        ...
        <div className="comments-list-feed">
          {comments.map(comment => <div key={comment.id} className="comment-feed-item">
