...
public class CheckoutSettings {
    ...
    private boolean phoneMandatoryForContent;
    private boolean houseNoMandatory;
    private boolean houseNoMandatoryForContent;
    private boolean streetMandatory;
    private boolean streetMandatoryForContent;
    private boolean cityMandatory;
    private boolean cityMandatoryForContent;
    private boolean pinCodeMandatory;
    private boolean pinCodeMandatoryForContent;
    ...
    private boolean enforceEmailVerificationForContent;
